...
class Activity[PlayerT: bascenev1.Player, TeamT: bascenev1.Team]:
    ...
    def __init__(self, settings: dict):
        ...
        # Ok, let's set up our tick stuff for our actors.
        self._tick_callbacks: list[Callable] = []
        # Update at roughly 60 FPS.
        self._tick_timer = bs.Timer(
            0.016, 
            self._call_tick_callbacks, 
            repeat=True,
        )
