...
class MainMenuActivity(bs.Activity[bs.Player, bs.Team]):
    ...
    def on_transition_in(self) -> None:
        ...
        # Developer builds get their own badge so that one escaping into
        # a store build is obvious at a glance. Takes precedence over the
        # test-build badge since it is the more important of the two to
        # catch. Untranslated on purpose; only developers ever see it.
        if env.developer_build:
            badge_text = 'Dev Build'
